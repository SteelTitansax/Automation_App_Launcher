...
const CPU = () => {
    const[cpuConnection,setCpuconnection] = useState(null); 
            ...
            <div className="col-md-4 p-2 panels">
                <div className="card h-100 border">
                    ...
                    <div className="card-body border-top" >
                        <h5 className="text-center"><strong>Cpu usage</strong></h5>
                        <p className="text-center">{cpuConnection.cpu}</p>
